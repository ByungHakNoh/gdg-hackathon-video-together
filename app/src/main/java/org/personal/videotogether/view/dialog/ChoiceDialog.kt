...
class ChoiceDialog : DialogFragment(), DialogInterface.OnClickListener {
    ...
    private val menuList: Int by lazy { requireArguments().getInt("arrayResource") }
    ...
    override fun onClick(dialog: DialogInterface?, which: Int) {
        dialogListener.onChoice(menuList, requireParentFragment().resources.getStringArray(menuList)[which], itemPosition, id)
    }
}